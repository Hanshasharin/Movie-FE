...
export function NavbarWithSearch() {
  ...
  const navList = (
    <ul className="mt-1 mb-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
  ...
  return (
    ...
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-1 lg:py-0">
      ...
      <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
        ...
        <form className="search-bar" onSubmit={handleSearchSubmit}>
          ...
          <Button size="md" className="rounded-lg link ">
